...
async def async_setup_entry(
    ...
    for device_id, device in devices.items():
        # Sowohl normale Panels als auch den Multisensor (VOCsensors) laden
...
class WibutlerClimate(WibutlerEntity, ClimateEntity):
    ...
    def supported_features(self):
        ...
        # Im Kühlmodus sperren wir die Temperaturregelung in der UI komplett
    ...
    def target_temperature(self):
        ...
        # Im Kühlmodus felsenfest 22.5°C in Home Assistant anzeigen
        if self._hvac_mode == HVACMode.COOL:
            return 22.5
    ...
    async def async_set_hvac_mode(self, hvac_mode: HVACMode) -> None:
        ...
        if hvac_mode == HVACMode.COOL:
            # Wibutler auf 30°C zwingen (API-Wert 40), damit Ventile voll öffnen
            ...
            # Vorherigen Heiz-Sollwert wiederherstellen
    ...
    async def async_set_temperature(self, **kwargs) -> None:
        ...
        # Im Kühlmodus manuelle Änderungen ignorieren
        if self._hvac_mode == HVACMode.COOL:
            return
    ...
    def _fetch_state(self, components) -> None:
        ...
        for component in components:
            ...
            # Liest normale TMP und Multisensor RTMP Werte aus
            if name in ("TMP", "RTMP"):
                try:
                ...
                try:
                    ...
                    # Wenn im Wibutler 30°C hinterlegt sind, sind wir im Kühlmodus
                    if temp_val >= 30.0:
